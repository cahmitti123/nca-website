...
export const DottedGlowBackground = ({
  ...
  useEffect(() => {
    ...
    const handleReducedMotion = () => {
      const shouldStop = reduceMotionMql.matches;
      if (shouldStop) {
        stopped = true;
        return;
      }
    ...
    stopped = reduceMotionMql.matches;
    reduceMotionMql.addEventListener("change", handleReducedMotion);
    ...
    return () => {
      ...
      reduceMotionMql.removeEventListener("change", handleReducedMotion);
      ro.disconnect();
    };
  }, [
    gap,
