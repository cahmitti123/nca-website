    ...
    >
      <div className="relative w-full">
            ...
            {items.map((item, index) => (
              <motion.div
                ...
                transition={
                  reduceMotion
                    ? { duration: 0 }
                    : { duration: 0.35, delay: 0.08 * index, ease: "easeOut" }
                }
        ...
        <div className="flex justify-end gap-2">
          <button
            className="bg-muted/60 relative z-40 flex h-9 w-9 items-center justify-center rounded-full border disabled:opacity-50"
            onClick={scrollLeft}
            disabled={!canScrollLeft}
            aria-label="Scroll left"
          >
            <IconArrowNarrowLeft className="text-muted-foreground h-5 w-5" />
          </button>
          <button
            className="bg-muted/60 relative z-40 flex h-9 w-9 items-center justify-center rounded-full border disabled:opacity-50"
            onClick={scrollRight}
          ...
          >
            <IconArrowNarrowRight className="text-muted-foreground h-5 w-5" />
          </button>
        </div>
      </div>
    </CarouselContext.Provider>
