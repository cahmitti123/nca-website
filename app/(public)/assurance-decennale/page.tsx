    ...
    <div className="space-y-10">
      <div className="space-y-3">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Badge variant="outline">Bâtiment</Badge>
          <Badge variant="outline">Décennale</Badge>
        </div>
        <h1 className="text-2xl font-semibold tracking-tight">Assurance décennale</h1>
        <p className="text-muted-foreground max-w-prose text-sm leading-relaxed">
          L’assurance décennale est essentielle pour les professionnels du bâtiment. Nous vous
          accompagnons pour cadrer les garanties selon votre activité et vos chantiers.
        </p>
        ...
        <Card className="border-muted/60">
          ...
          <CardContent className="space-y-3 pt-4">
            ...
            <Button size="sm" variant="outline" className="w-full" asChild>
              <Link href="/portail/assurances-entreprise">Portail entreprise</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
